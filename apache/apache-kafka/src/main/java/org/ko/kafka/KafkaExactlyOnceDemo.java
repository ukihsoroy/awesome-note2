 ...
 *    tailing data from input topic (See {@link kafka.examples.ExactlyOnceMessageProcessor}). Each EOS instance will
...
public class KafkaExactlyOnceDemo {
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        kafka.examples.Producer producerThread = new kafka.examples.Producer(INPUT_TOPIC, false, null, true, numRecords, -1, prePopulateLatch);
        ...
        for (int instanceIdx = 0; instanceIdx < numInstances; instanceIdx++) {
            kafka.examples.ExactlyOnceMessageProcessor messageProcessor = new kafka.examples.ExactlyOnceMessageProcessor(
    ...
    private static void recreateTopics(final int numPartitions)
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,
            kafka.examples.KafkaProperties.KAFKA_SERVER_URL + ":" + kafka.examples.KafkaProperties.KAFKA_SERVER_PORT);
